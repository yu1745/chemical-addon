...
/**
 * 高锰酸钾 KMnO4 生产流程（Track C 蓝图，见 PLAN.md）。
 *
 * <p>步骤在原料类之间不去重：为保持每条流程的完整性，与其它类重复的步骤原样保留。
 * 引擎反应式（reaction）遵循 {@link com.yu1745.chemengine.Equilibrium#parse} 语法；
 * 传统化学式与工艺条件见各步 note。
 */
public final class PotassiumPermanganateProcess {

    /** 中文名/化学式。 */
    public static final String NAME = "高锰酸钾 KMnO4";
    ...
    public static final List<ProcessStep> STEPS = List.of(
        ProcessStep.no("【留空·待实现】 2 MnO2 + 4 KOH + O2 --熔融--> 2 K2MnO4 + 2 H2O；3 K2MnO4 + 2 H2SO4 -> 2 KMnO4 + MnO2↓ + 2 K2SO4 + 2 H2O（缺锰物种）")
    );

    private PotassiumPermanganateProcess() {}
}
