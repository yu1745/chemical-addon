...
SOLIDS = [
    ...
    ("iodine",                 "碘",     "Iodine",          0x343044),
    ("manganese_dioxide",      "二氧化锰", "Manganese Dioxide", 0x3A342E),
...
BLOCKS = [
	...
	("process_state_transmitter", "过程状态发送器", "Process State Transmitter", 0x76695E),
	("plc_controller",      "化工 PLC", "Chemical PLC",      0xB87333),
	("plc_io",              "PLC 输入输出模块", "PLC I/O Module", 0x6E6E6E),
	("test_paper_detector", "试纸检测箱", "Test Paper Detector", 0x6E5A8A),
	("orp_gauge",           "ORP / pe 计", "ORP / pe Gauge", 0x6A4A7A),
	("flow_meter",          "流量计", "Flow Meter", 0x4A748A),
	("solid_bed_gauge",     "固体料层计", "Solid Bed Gauge", 0x7A684A),
]
...
TEST_PAPERS = [
	...
	("hypochlorite_paper",          "有效氯试纸", "Effective Chlorine Paper", "HYPOCHLORITE", 0xD9E67A),
	("sulfite_paper",               "亚硫酸盐试纸", "Sulfite Paper", "SULFITE", 0xD8D1A8),
	("ammonium_paper",              "铵离子试纸", "Ammonium Paper", "AMMONIUM", 0x78B7D0),
	("nitrate_nitrite_paper",       "硝酸盐亚硝酸盐试纸", "Nitrate/Nitrite Paper", "NITRATE_NITRITE", 0xE0B070),
	("ferrous_ferric_paper",        "亚铁铁离子试纸", "Ferrous/Ferric Paper", "FERROUS_FERRIC", 0xA65A45),
	("hardness_paper",              "硬度试纸", "Hardness Paper", "HARDNESS", 0x77A8C8),
	("ammonia_gas_paper",           "氨气检测试纸", "Ammonia Gas Paper", "AMMONIA_GAS", 0x9FCED5),
	("sulfur_dioxide_gas_paper",    "二氧化硫检测试纸", "Sulfur Dioxide Gas Paper", "SULFUR_DIOXIDE_GAS", 0xD0C777),
	("chlorine_gas_paper",          "氯气检测试纸", "Chlorine Gas Paper", "CHLORINE_GAS", 0xB6D75B),
	("nox_gas_paper",               "氮氧化物检测试纸", "NOx Gas Paper", "NOX_GAS", 0xB56B45),
]
...
EXTRA_LANG_ZH = {
	...
	"goggles.chemicaladdon.plc": "PLC：%s / %s",
	"goggles.chemicaladdon.process_state_transmitter": "过程状态：%s",
	"goggles.chemicaladdon.process_state_transmitter_progress": "进度：%s%%",
	"message.chemicaladdon.process_state_transmitter": "过程状态发送器：%s",
	"process_state_transmitter.chemicaladdon.unbound": "未连接过程设备",
	"goggles.chemicaladdon.plc_fault": "故障：%s",
	"goggles.chemicaladdon.plc_io": "PLC 输入输出模块",
	"goggles.chemicaladdon.test_paper_detector": "试纸检测箱",
	"detector.chemicaladdon.minimum": "量程下限",
	"detector.chemicaladdon.maximum": "量程上限",
	"detector.chemicaladdon.no_paper": "未装试纸",
	"detector.chemicaladdon.range": "量程：%s‰ ～ %s‰",
	"detector.chemicaladdon.signal": "输出信号：%s",
	"screen.chemicaladdon.plc.placeholder": "输入 PLC 指令或 function scan(plc) { ... }",
	"screen.chemicaladdon.plc.save": "保存",
	"screen.chemicaladdon.plc.run": "运行",
	"screen.chemicaladdon.plc.stop": "停止",
	"screen.chemicaladdon.plc.instruction": "指令模式",
	"screen.chemicaladdon.plc.javascript": "JS 模式",
	"paper.chemicaladdon.target_positive": "%s：检出",
	"paper.chemicaladdon.target_negative": "%s：未检出",
	"paper.chemicaladdon.target.hypochlorite": "有效氯",
	"paper.chemicaladdon.target.sulfite": "亚硫酸盐",
	"paper.chemicaladdon.target.ammonium": "铵离子",
	"paper.chemicaladdon.target.nitrate_nitrite": "硝酸盐/亚硝酸盐",
	"paper.chemicaladdon.target.ferrous_ferric": "亚铁/铁离子",
	"paper.chemicaladdon.target.hardness": "钙镁硬度",
	"paper.chemicaladdon.target.ammonia_gas": "氨气",
	"paper.chemicaladdon.target.sulfur_dioxide_gas": "二氧化硫",
	"paper.chemicaladdon.target.chlorine_gas": "氯气",
	"paper.chemicaladdon.target.nox_gas": "氮氧化物",
	"gauge.chemicaladdon.minimum": "量程下限",
	"gauge.chemicaladdon.maximum": "量程上限",
	"goggles.chemicaladdon.flow": "流量：%s mB/拍",
	"goggles.chemicaladdon.solid_bed": "固体料层：%s mB",
	"orp_gauge.chemicaladdon.maximum": "pe 量程上限",
	"goggles.chemicaladdon.orp": "pe：%s",
	"goggles.chemicaladdon.range": "量程：%s ～ %s",
...
EXTRA_LANG_EN = {
	...
	"goggles.chemicaladdon.plc": "PLC: %s / %s",
	"goggles.chemicaladdon.process_state_transmitter": "Process state: %s",
	"goggles.chemicaladdon.process_state_transmitter_progress": "Progress: %s%%",
	"message.chemicaladdon.process_state_transmitter": "Process state transmitter: %s",
	"process_state_transmitter.chemicaladdon.unbound": "Not attached to process equipment",
	"goggles.chemicaladdon.plc_fault": "Fault: %s",
	"goggles.chemicaladdon.plc_io": "PLC I/O Module",
	"goggles.chemicaladdon.test_paper_detector": "Test Paper Detector",
	"detector.chemicaladdon.minimum": "Range minimum",
	"detector.chemicaladdon.maximum": "Range maximum",
	"detector.chemicaladdon.no_paper": "No paper installed",
	"detector.chemicaladdon.range": "Range: %s‰ to %s‰",
	"detector.chemicaladdon.signal": "Output signal: %s",
	"screen.chemicaladdon.plc.placeholder": "Enter PLC instructions or function scan(plc) { ... }",
	"screen.chemicaladdon.plc.save": "Save",
	"screen.chemicaladdon.plc.run": "Run",
	"screen.chemicaladdon.plc.stop": "Stop",
	"screen.chemicaladdon.plc.instruction": "Instruction",
	"screen.chemicaladdon.plc.javascript": "JavaScript",
	"paper.chemicaladdon.target_positive": "%s: detected",
	"paper.chemicaladdon.target_negative": "%s: not detected",
	"paper.chemicaladdon.target.hypochlorite": "effective chlorine",
	"paper.chemicaladdon.target.sulfite": "sulfite",
	"paper.chemicaladdon.target.ammonium": "ammonium",
	"paper.chemicaladdon.target.nitrate_nitrite": "nitrate/nitrite",
	"paper.chemicaladdon.target.ferrous_ferric": "ferrous/ferric iron",
	"paper.chemicaladdon.target.hardness": "calcium/magnesium hardness",
	"paper.chemicaladdon.target.ammonia_gas": "ammonia gas",
	"paper.chemicaladdon.target.sulfur_dioxide_gas": "sulfur dioxide",
	"paper.chemicaladdon.target.chlorine_gas": "chlorine gas",
	"paper.chemicaladdon.target.nox_gas": "nitrogen oxides",
	"gauge.chemicaladdon.minimum": "Range minimum",
	"gauge.chemicaladdon.maximum": "Range maximum",
	"goggles.chemicaladdon.flow": "Flow: %s mB/scan",
	"goggles.chemicaladdon.solid_bed": "Solid bed: %s mB",
	"orp_gauge.chemicaladdon.maximum": "pe range maximum",
	"goggles.chemicaladdon.orp": "pe: %s",
	"goggles.chemicaladdon.range": "Range: %s to %s",
