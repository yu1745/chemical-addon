...
| Create Forge + 自研全部化学管线 | 已选，但化学管线**只做状态敏感部分**（见 D12），标准态液体/配方/热/物流全部复用 Create |
...
- **自研**：釜体（多方块处理机）、气体管/泵/阀（Create 6.0.8 **无气体系统**）、流股储罐、压缩机、换热器、电解槽、过滤机、蒸馏塔板、冷却塔、净化塔、控制面板、仪表、催化剂托盘（约 25–30 方块）。
